            ...
            <div className="tavi-card">
                ...
                <div style={{ marginBottom: 8 }}>
                  {(() => {
                    ...
                    const Section = ({ num, title, children }: { num: string; title: string; children: React.ReactNode }) => (
                      <div style={{ margin: '0 0 6px', padding: '6px 8px', background: 'rgba(255,255,255,0.03)', borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              {workflowPhase === 'centerline-review' && (
                <div style={{ marginBottom: 8 }}>
                  ...
                  <div style={{ margin: '8px 0', padding: '6px 8px', background: 'rgba(255,255,255,0.03)', borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              {workflowPhase === 'cusp-definition' && (
                <div>
                  ...
                  <div style={{ margin: '0 0 8px', padding: '6px 8px', background: 'rgba(255,255,255,0.03)', borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)' }}>
